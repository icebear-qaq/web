...
import sty from "./PlasmicCandidate.module.css"; // plasmic-import: MjKPaFF3yDAE/css
  ...
  const new$Queries: Record<string, ReturnType<typeof usePlasmicDataOp>> = {
    positions: usePlasmicDataOp(() => {
      return {
        ...
        opId: "fe2a67b6-a85f-489b-90bd-e3b11699ccad",
        userArgs: {},
        cacheKey: `plasmic.$.fe2a67b6-a85f-489b-90bd-e3b11699ccad.$.`,
    ...
    candidate: usePlasmicDataOp(() => {
      return {
        sourceId: "gtYKLw7KRCthUM7M1zjfhd",
        opId: "977aa685-146c-4441-995a-d1718e28338d",
        userArgs: {
          filters: [$ctx.params.id]
        },
        cacheKey: `plasmic.$.977aa685-146c-4441-995a-d1718e28338d.$.`,
        invalidatedKeys: null,
        roleId: "5d3748e7-f61b-4382-88c0-b75d69da4ab9"
      };
    })
                        ...
                        $steps["tutorialdbUpdateMany"] = true
                          ? (() => {
                              const actionArgs = {
                                dataOp: {
                                  sourceId: "gtYKLw7KRCthUM7M1zjfhd",
                                  opId: "6173020c-e4cc-4e23-befe-0e632f21f5d5",
                                  userArgs: {
