...
import Card from "../../Card"; // plasmic-import: tXpBQNoyzXVh/component
...
import sty from "./PlasmicPosition.module.css"; // plasmic-import: oC-FqiwYQJ6W/css
  ...
  const new$Queries: Record<string, ReturnType<typeof usePlasmicDataOp>> = {
    position: usePlasmicDataOp(() => {
      return {
        ...
        opId: "5bb28597-b2bd-429a-b5e9-a45397159835",
        userArgs: {
          filters: [$ctx.params.id]
        },
        cacheKey: `plasmic.$.5bb28597-b2bd-429a-b5e9-a45397159835.$.`,
    ...
    candidates: usePlasmicDataOp(() => {
      return {
        sourceId: "gtYKLw7KRCthUM7M1zjfhd",
        opId: "96df5d3f-5e29-4936-a6db-a0cfaa2fe377",
        userArgs: {
          filters: [$ctx.params.id]
        },
        cacheKey: `plasmic.$.96df5d3f-5e29-4936-a6db-a0cfaa2fe377.$.`,
        invalidatedKeys: null,
        roleId: "5d3748e7-f61b-4382-88c0-b75d69da4ab9"
      };
    })
            ...
            <DataCtxReader__>
              {$ctx => (
                ...
                >
                        ...
                        $steps["tutorialdbUpdateMany"] = true
                          ? (() => {
                              const actionArgs = {
                                dataOp: {
                                  sourceId: "gtYKLw7KRCthUM7M1zjfhd",
                                  opId: "7f031f2d-83bb-47ee-a085-128d63ea3d1b",
                                  userArgs: {
                  ...
                  <Card
                    className={classNames("__wab_instance", sty.card___2Z0HI)}
                    noTitle={true}
                  >
                    <RichDetails
                  ...
                  <Card
                    className={classNames("__wab_instance", sty.card__f0JxJ)}
                    title={
                      <h4
